          ...
          <ul>
            <li class="" v-for="item in menu" :key="item.id">
              <a @click="clickMenuItem(item.section)">
                <div class="title">
                    <span class="text write" data-splitting="lines" v-if="item.icon === 'home'">
                      <Home/>
                    </span>
                  <span class="text write" data-splitting="lines" v-else-if="item.icon === 'information'">
                      <Information/>
                    </span>
...
<style scoped>
  ...
  .menuListMobile {
    ...
    margin-right: 5vh;
    opacity: 0;
    animation: showUp 2s 1s forwards;
  }
